...
public class CLI_GUI extends Application
{
	...
	public void start(Stage stage) 
	{
		...
		ObservableList<String> suspectsList = FXCollections.<String>observableArrayList("Green", "Mustard", "Peacock", "Plum", "Scarlet", "White");
		ObservableList<String> locationsList = FXCollections.<String>observableArrayList("Ballroom", "Billiard", "Conservatory", "Dining", "Hall", "Kitchen", "Library", "Lounge", "Study");
		ObservableList<String> weaponsList = FXCollections.<String>observableArrayList("Revolver", "Pipe", "Rope", "Candlestick", "Wrench", "Dagger");
		ObservableList<String> directionsList = FXCollections.<String>observableArrayList("north", "south", "east", "west");
		ObservableList<String> othersList = FXCollections.<String>observableArrayList("exit","quit", "help", "start", "done", "chat", "cards", "board", "diprove");
		...
		suspects.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>()
		{
		...
		locations.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>()
		{
		    public void changed(ObservableValue<? extends String> ov,
		            final String oldvalue, final String newvalue) 
		    {
		...
		weapons.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>()
		{
		    public void changed(ObservableValue<? extends String> ov,
		            final String oldvalue, final String newvalue) 
		    {
		...
		directions.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>()
		{
		    public void changed(ObservableValue<? extends String> ov,
		            final String oldvalue, final String newvalue) 
		    {
		...
		others.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<String>()
		{
		    public void changed(ObservableValue<? extends String> ov,
		            final String oldvalue, final String newvalue) 
		    {
	...
	public void suspectsChanged(ObservableValue<? extends String> observable,String oldValue,String newValue) 
	{
	...
	public void locationsChanged(ObservableValue<? extends String> observable,String oldValue,String newValue) 
	{
		String oldText = oldValue == null ? "null" : oldValue.toString();
		String newText = newValue == null ? "null" : newValue.toString();
	...
	public void weaponsChanged(ObservableValue<? extends String> observable,String oldValue,String newValue) 
	{
		String oldText = oldValue == null ? "null" : oldValue.toString();
		String newText = newValue == null ? "null" : newValue.toString();
	...
	public void directionsChanged(ObservableValue<? extends String> observable,String oldValue,String newValue) 
	{
		String oldText = oldValue == null ? "null" : oldValue.toString();
		String newText = newValue == null ? "null" : newValue.toString();
	...
	public void othersChanged(ObservableValue<? extends String> observable,String oldValue,String newValue) 
	{
		String oldText = oldValue == null ? "null" : oldValue.toString();
		String newText = newValue == null ? "null" : newValue.toString();
