...
public class CluelessServerSocket {
    ...
    private static final Logger logger = LogManager.getLogger(CluelessServerSocket.class);
    ...
    public ServerSocket getServerSocket() throws Exception {
        try {
            this.svcSocket = new ServerSocket(this.svcPort, this.svcBacklog, this.svcBindAddr);
        } catch (IOException e) {
    ...
    public ServerSocketChannel getServerSocketChannel() throws Exception {
        ...
        InetSocketAddress sockaddr = new InetSocketAddress(this.svcBindAddr, this.svcPort);
